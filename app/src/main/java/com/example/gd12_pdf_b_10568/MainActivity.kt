package com.example.gd12_pdf_b_10568
...
import com.example.gd12_pdf_b_10568.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama:String,umur:String,tlp:String,alamat:String,kampus:String){
        ...
        val file = File(pdfPath,"pdf_10568.pdf")
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.cyno)
